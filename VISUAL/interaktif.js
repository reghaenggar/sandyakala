...
// CARD GRID VIDEO SELAMAT DATANG
...
const wawasanData = [
  {
    ...
    slides: [
      { image: "olga.jpeg", text: "fasilitas olahraga kampus gratis yang berada di Taman Randu." },
  ...
  },
  {
    ...
    slides: [
      { image: "ormawa-1.jpg", text: "Booklet lengkap berisi profil organisasi kemahasiswaan di UNY." },
      { image: "ormawa-2.jpg", text: "Info kontak dan kegiatan rutin tiap organisasi mahasiswa." }
    ]
  },
  {
    tag: "PKKMB",
...
// MODAL (KEGIATAN HARIA/INFO FASILITAS)
...
// ── GRASS ZIGZAG DIVIDER (generate otomatis, ga perlu hitung koordinat manual)
